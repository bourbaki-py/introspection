...
class some_class:
    ...
    some_method.__classpath__ = "{}.{}.{}".format(
        __name__, "some_class", some_method.__name__
    )
...
class some_generic(Generic[T]):
    ...
    some_generic_method.__classpath__ = "{}.{}.{}".format(
        __name__, "some_generic", some_generic_method.__name__
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            some_generic.some_generic_method,
            some_generic.some_generic_method.__classpath__,
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Callable[[Mapping[Tuple[str,int],List[bool]]],{}]".format(
                some_generic.__classpath__
            ),
        ),
        (some_class, some_class.__classpath__),
        (some_generic, some_generic.__classpath__),
